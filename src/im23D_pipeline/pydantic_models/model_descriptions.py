...
data_file_type_description = "file type ending (e.g. .obj, .glb, .etc) *needs* to be a 3D file readable by `trimesh`!"
...
refresh_data_catalog_description = (
    "runs the function that regenerates the data catalog, unless new data is put in there, this should be left as `False`"
)
datacatalog_path_description = "could be changed, but outputs a glob string where dask will write out the dataset parts."
