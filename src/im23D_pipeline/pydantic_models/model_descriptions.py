...
dataset_list_description = "list of .obj or .glb files (Path Objects) that point to the files to be written to the data catalog"
protocol_description = f"""protocol that's used for remote file storage. Current supported files are: {known_implementations}"""
